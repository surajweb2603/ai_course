...
const mainFeatures = [
  {
    ...
    description:
      'Generate complete course outlines with modules, lessons, and quizzes in minutes. Our AI creates structured educational content tailored to your topic.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'AI writes detailed lesson content with examples, explanations, and practical exercises. Get comprehensive educational material without manual work.',
    highlights: [
  ...
  },
  {
    ...
    title: 'AI Tutor Chat',
    description:
      'Get instant help with our AI tutor. Ask questions about course content and receive detailed explanations and guidance.',
    highlights: [
      'Instant responses',
  ...
  },
  {
    ...
    description:
      'Monitor learning progress with detailed analytics. Track completion rates, quiz scores, and course engagement.',
    highlights: [
      'Completion tracking',
  ...
  },
  {
    ...
    description:
      'Automatically find and integrate relevant educational images. AI searches for appropriate visuals to enhance course content.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Embed educational videos from YouTube to complement lessons. AI finds relevant video content for each topic automatically.',
    highlights: [
...
const useCases = [
  {
    title: 'For Educators',
    description:
      'Create engaging courses faster than ever. Focus on teaching while AI handles content creation.',
    icon: User,
  ...
  },
  {
    title: 'For Students',
    description:
      'Learn at your own pace with personalized AI guidance. Access courses in your native language.',
    icon: GraduationCap,
    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-purple-50/30 to-blue-50/40 pt-16 sm:pt-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 relative z-10 overflow-visible">
        ...
        >
          ...
          >
            Everything you need to create, deliver, and scale world-class educational content
...
function FeatureCard({ feature, index }: FeatureCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col">
        ...
        <ul className="space-y-2">
          {feature.highlights.map((highlight, idx) => (
            ...
            >
              <svg
                className={`w-4 h-4 flex-shrink-0 text-purple-600`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <div
        className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${gradient} opacity-0 group-hover:opacity-5 rounded-bl-full transition-opacity duration-500`}
      />
    </motion.div>
  );
}
...
interface AdditionalFeatureCardProps {
  feature: (typeof additionalFeatures)[0];
  index: number;
}

function AdditionalFeatureCard({ feature, index }: AdditionalFeatureCardProps) {
  return (
    <motion.div
      variants={fadeUp}
      initial={{ opacity: 0, y: 60 }}
    ...
    >
      ...
      <div
        className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-10 rounded-bl-full transition-opacity duration-500`}
      />
    </motion.div>
  );
}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {additionalFeatures.map((feature, index) => (
            <AdditionalFeatureCard key={index} feature={feature} index={index} />
          ))}
        </motion.div>
      </div>
    </section>
    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Built For Everyone</h2>
...
interface ComparisonRowProps {
  item: (typeof comparisonFeatures)[0];
  index: number;
}
    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">How We Compare</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
...
function CTASection({ isLoggedIn }: CTASectionProps) {
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            Start creating amazing courses today with our AI-powered platform. No credit card
            required.
          </p>
