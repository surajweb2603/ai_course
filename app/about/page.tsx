...
import { Sparkles, Users, BookOpen, Globe, Heart, Target, Rocket, Handshake, Lightbulb, GraduationCap } from 'lucide-react';
import Link from 'next/link';

const stats = [
  { value: '50K+', label: 'Active Learners', icon: Users, gradient: 'from-purple-500 to-indigo-600' },
  { value: '10K+', label: 'Courses Created', icon: BookOpen, gradient: 'from-blue-500 to-cyan-600' },
  { value: '23+', label: 'Languages', icon: Globe, gradient: 'from-green-500 to-emerald-600' },
  { value: '95%', label: 'Satisfaction Rate', icon: Heart, gradient: 'from-red-500 to-pink-600' },
];
...
const values = [
  ...
  },
  {
    ...
    description: 'Pushing the boundaries of AI to create better learning experiences.',
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 border border-purple-200/50 shadow-sm backdrop-blur-sm">
                ...
                >
                  <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" strokeWidth={1.5} />
                </motion.div>
            ...
            >
              We're on a mission to make quality education accessible to everyone through the power of artificial intelligence. Our platform empowers educators and learners worldwide.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 bg-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <p>
                AiCourse Generator was born from a simple observation: creating quality educational content is time-consuming and expensive, while millions of people worldwide lack access to personalized learning experiences.
              </p>
              <p>
                In 2023, our founders—a team of AI researchers, educators, and technologists—came together with a vision to democratize education through artificial intelligence. We believed that AI could not only make content creation faster but also make learning more personalized and effective.
              </p>
              <p>
                Today, we're proud to serve over 50,000 learners and educators across 150+ countries, offering courses in 23+ languages. But we're just getting started. Our goal is to make quality education accessible to everyone, everywhere.
              </p>
            </motion.div>
          </motion.div>
        </div>
          ...
          >
            <div className="relative bg-gradient-to-br from-purple-50/80 to-purple-100/80 backdrop-blur-sm border border-purple-200/50 rounded-3xl p-8 sm:p-12 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                >
                  Whether you're an educator looking to create courses or a learner seeking knowledge, we'd love to have you as part of our community.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  transition={{ delay: 0.3 }}
                >
                  <Link href={isLoggedIn ? "/dashboard" : "/register"} className="inline-block">
                    <motion.div
                      whileHover={{ 
                        scale: 1.05,
