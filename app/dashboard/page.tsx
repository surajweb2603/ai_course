...
import { BookOpen, Clock, Target, Trophy, Sparkles, BookText, BarChart3, Shield, Mail, Zap, CheckCircle2, Circle } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch progress for each new course
  ...
  const handleCreateCourse = () => {
    // Check if free user has reached course limit
    if (user?.plan === 'free' && totalCourses >= 1) {
      window.location.href = '/pricing';
      return;
    }
    
    // Open course creation page in new tab
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          ...
          <p className="text-gray-600 text-base sm:text-lg md:text-xl max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
            Manage your AI-generated courses, track your progress, and unlock the power of personalized learning.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <div 
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center bg-purple-100 group-hover:scale-110 transition-transform duration-300"
                >
                  <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" />
                </div>
              </div>
              <h3 className="text-2xl sm:text-3xl font-bold mb-1 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent group-hover:from-purple-700 group-hover:to-blue-700 transition-colors">{stats.coursesCreated}</h3>
              <p className="text-xs sm:text-sm text-gray-600 font-medium">Courses Created</p>
            </div>
          </motion.div>

          {/* Stat Card 2 - Learning Time */}
          <motion.div 
            className="group relative bg-white border border-gray-200 rounded-xl p-4 sm:p-6 transition-all duration-300 hover:border-purple-300 hover:shadow-lg hover:-translate-y-2 shadow-sm"
            whileHover={{ scale: 1.03, y: -8 }}
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-1 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent group-hover:from-purple-700 group-hover:to-blue-700 transition-colors">{stats.learningTime}</h3>
              <p className="text-xs sm:text-sm text-gray-600 font-medium">Learning Time</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-1 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent group-hover:from-purple-700 group-hover:to-blue-700 transition-colors">{stats.completionRate}%</h3>
              <p className="text-xs sm:text-sm text-gray-600 font-medium">Completion Rate</p>
            </div>
          </motion.div>

          {/* Stat Card 4 - Achievements */}
          <motion.div 
            className="group relative bg-white border border-gray-200 rounded-xl p-4 sm:p-6 transition-all duration-300 hover:border-purple-300 hover:shadow-lg hover:-translate-y-2 shadow-sm"
            whileHover={{ scale: 1.03, y: -8 }}
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-1 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent group-hover:from-purple-700 group-hover:to-blue-700 transition-colors">{stats.achievements}</h3>
              <p className="text-xs sm:text-sm text-gray-600 font-medium">Achievements</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div 
            className="flex gap-2 bg-white border border-gray-200 rounded-xl p-2 inline-flex min-w-full sm:min-w-0 shadow-sm"
          >
            <button
            ...
            >
              ...
              <span className="relative z-10">My Courses ({totalCourses})</span>
            </button>
            <button
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-1">
                        ...
                        <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2">Create New Course</h3>
                    ...
                    >
                      ...
                      <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-gray-900 group-hover:text-purple-600 transition-colors">Browse Library</h3>
                      <p className="text-xs sm:text-sm text-gray-600 group-hover:text-gray-700 transition-colors">View your {totalCourses} courses</p>
                      <svg 
                ...
                {/* Recent Courses - Show new courses first */}
                {newCourses.length > 0 && (
                  <div className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          <div className="w-1 h-6 bg-gradient-to-b from-purple-600 to-pink-600 rounded-full"></div>
                          <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Recent Courses</h2>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      {newCourses.slice(0, 4).map((course, index) => (
                        <motion.div
                          key={course._id}
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                ...
                {totalCourses === 0 && (
                  <div className="bg-white border border-gray-200 rounded-xl p-12 text-center shadow-sm">
                    ...
                    <h3 className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 bg-clip-text text-transparent mb-2">No Courses Yet</h3>
                    <p className="text-gray-600 mb-6 max-w-md mx-auto font-medium">Start your learning journey by creating your first AI-powered course!</p>
                    <motion.button
                      whileHover={{ 
                        scale: 1.08,
                        boxShadow: "0 25px 50px rgba(139, 92, 246, 0.4)",
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-4 sm:mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{newCourses.length} course{newCourses.length !== 1 ? 's' : ''}</p>
                        </div>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-4 sm:mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{oldCourses.length} course{oldCourses.length !== 1 ? 's' : ''}</p>
                        </div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        {oldCourses.map((course, index) => (
                          ...
                          >
                            <div className={`w-full h-24 sm:h-32 bg-gradient-to-br ${getCategoryColor(course.category)} rounded-xl mb-3 sm:mb-4 flex items-center justify-center`}>
          ...
          {activeTab === 'analytics' && (
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-sm">
                ...
                <p className="text-gray-600 text-sm mb-8 ml-3">Track your progress and performance metrics</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-purple-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="w-16 h-16 rounded-full border-4 border-purple-200 flex items-center justify-center">
                        <span className="text-xs font-bold text-purple-600">{Math.min(Math.round((stats.learningTimeMinutes / 6000) * 100), 100)}%</span>
                      </div>
                    </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-purple-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="w-16 h-16 rounded-full border-4 border-purple-200 flex items-center justify-center">
                        <span className="text-xs font-bold text-purple-600">{Math.min(Math.round((stats.achievements / 50) * 100), 100)}%</span>
                      </div>
                    </div>
