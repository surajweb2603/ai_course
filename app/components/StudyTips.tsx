  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 bg-white">
            ...
            >
              ...
              <div className="relative z-10 flex items-start gap-3 sm:gap-4">
                ...
                >
                  ...
                  <Icon className={`w-5 h-5 sm:w-6 sm:h-6 ${tip.color} relative z-10`} />
                </motion.div>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="mt-8 sm:mt-12 lg:mt-16 max-w-4xl mx-auto px-4"
      >
        <motion.div 
          ...
          <div className="relative z-10 flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed transition-colors duration-300">
                Don't hesitate to ask questions! Your AI tutor is available 24/7 to help clarify concepts, 
                provide examples, and guide your learning. The more you interact, the better your understanding becomes. 
                Treat it like a personal study partner that never gets tired.
              </p>
            </div>
          </div>
