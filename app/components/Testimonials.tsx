        ...
        >
          {displayedTestimonials.map((testimonial, index) => (
            <motion.div
              ...
              className={`relative bg-white border-2 rounded-xl p-4 sm:p-6 hover:shadow-2xl transition-all duration-300 overflow-hidden ${
                index === 1 ? 'border-purple-400 shadow-xl ring-2 ring-purple-200' : 'border-gray-200 hover:border-purple-300'
              }`}
            >
              {/* Gradient overlay */}
              <div className={`absolute inset-0 bg-gradient-to-br from-purple-50/0 via-purple-50/0 to-purple-50/0 hover:from-purple-50/30 hover:via-purple-50/20 hover:to-purple-50/30 transition-all duration-500 rounded-xl ${
                index === 1 ? 'from-purple-50/20 via-purple-50/15 to-purple-50/20' : ''
              }`} />
              
              {/* Glow effect */}
              <div className={`absolute -inset-1 bg-gradient-to-r from-purple-400 to-purple-600 rounded-xl blur-xl opacity-0 hover:opacity-25 transition-opacity duration-500 -z-10 ${
                index === 1 ? 'opacity-15' : ''
              }`} />
